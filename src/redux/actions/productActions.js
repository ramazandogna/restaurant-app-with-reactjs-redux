...
export function createProductSuccess(product) {
    return { types: actionTypes.CREATE_PRODUCT_SUCCESS, payload: product }
}

export function uptadeProductSuccess(product) {
    return { types: actionTypes.UPTADE_PRODUCT_SUCCESS, payload: product }
}
...
export function handleError(error) {
    console.error("Bir hata ile karşılaşıldı")
    throw error;
}
